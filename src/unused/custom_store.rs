...
pub fn main() {
    ...
    let db_path = PathBuf::from("/Users/shamix/test_chain")
    ...
    for item in provider_storage.provided() {
        println!("Provided: {:?}", item);
    }

    println!("Provided: {}", provided_collection.len());
